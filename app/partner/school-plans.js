import { PartnerSchoolPlansScreen } from '../../components/partner';

/**
 * Plans for Schools — native.
 *
 ...
 */
export default function PartnerSchoolPlans() {
  return <PartnerSchoolPlansScreen />;
}
