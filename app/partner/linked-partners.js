import { PartnerLinkedPartnersScreen } from '../../components/partner';

/**
 * Linked Partners — native.
 *
 ...
 */
export default function PartnerLinkedPartners() {
  return <PartnerLinkedPartnersScreen />;
}
