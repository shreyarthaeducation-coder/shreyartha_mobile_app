import { PartnerSchoolAnalyticsScreen } from '../../components/partner';

/**
 * School Analytics — native.
 *
 ...
 */
export default function PartnerSchoolAnalytics() {
  return <PartnerSchoolAnalyticsScreen />;
}
