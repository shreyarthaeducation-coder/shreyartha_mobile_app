...
const styles = StyleSheet.create({
  ...
  backText: { color: COLORS.primary, fontWeight: '600', fontSize: TYPE.heading },
  headerTitle: { fontSize: TYPE.title, fontWeight: '700', color: COLORS.secondary, flex: 1, textAlign: 'center' },
  scroll: { flex: 1 },
  ...
  heroTitle: { fontSize: TYPE.display, fontWeight: '800', color: '#fff', textAlign: 'center', marginBottom: 8 },
  heroSubtitle: { fontSize: TYPE.heading, color: 'rgba(255,255,255,0.9)', textAlign: 'center', marginBottom: 12, fontStyle: 'italic' },
  heroDesc: { fontSize: TYPE.body, color: 'rgba(255,255,255,0.8)', textAlign: 'center', lineHeight: leading(TYPE.body), marginBottom: 20 },
  heroBtns: { flexDirection: 'row', gap: 12 },
  heroBtn: { backgroundColor: '#fff', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 28 },
  heroBtnText: { fontWeight: '700', fontSize: TYPE.heading, color: COLORS.primary },
  ...
  ctaTitle: { fontSize: TYPE.headline, fontWeight: '800', color: '#fff', textAlign: 'center', marginBottom: 8 },
  ctaSubtitle: { fontSize: TYPE.body, color: 'rgba(255,255,255,0.85)', textAlign: 'center', marginBottom: 20, lineHeight: leading(TYPE.body) },
  ctaBtn: { backgroundColor: '#fff', paddingVertical: 12, paddingHorizontal: 36, borderRadius: 24 },
  ctaBtnText: { fontWeight: '700', fontSize: TYPE.heading, color: COLORS.primary },
  footer: { backgroundColor: '#1a1a2e', padding: SPACING.lg, marginTop: SPACING.lg },
  footerBrand: { fontSize: TYPE.headline, fontWeight: '800', color: '#fff', marginBottom: 8 },
  footerTagline: { fontSize: TYPE.body, color: 'rgba(255,255,255,0.7)', marginBottom: 20, lineHeight: leading(TYPE.body) },
  ...
  footerLink: { fontSize: TYPE.label, color: 'rgba(255,255,255,0.8)' },
  footerCopy: { fontSize: TYPE.label, color: 'rgba(255,255,255,0.5)', textAlign: 'center', marginTop: 8 },
});
