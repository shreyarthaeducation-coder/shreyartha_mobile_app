...
export default function LandingScreen() {
  ...
  const features = [
    {
      ...
      description: "Cambridge-aligned standards and Ivy League benchmarking",
      slug: "learning-assessment",
    },
    {
      icon: "🧠",
    ...
    },
    {
      ...
      description: "Expert counseling for informed career decisions",
      slug: "subject-career",
    },
    {
      icon: "🌍",
      title: "Global Opportunities",
      description: "University placements in India and abroad",
      slug: "global-opportunities",
    },
    {
      icon: "🚀",
      title: "Skills Learning",
      description: "Future-ready skills aligned with NEP 2020 and WEF",
    ...
    },
    {
      ...
      description: "Build a comprehensive academic profile",
      slug: "students-profile",
    },
    {
      icon: "🤗",
      title: "Counselling",
      description: "24/7 AI-empowered support and guidance",
      slug: "counselling",
    },
    {
      icon: "🏆",
      title: "Competitive Examination",
      description: "Prepare for national and international exams",
      slug: "competitive-examination",
    },
    {
      icon: "🤖",
      title: "AI/Robotics & Coding",
      description: "Hands-on AI, robotics, and coding skills",
      slug: "coding-ai-robotics",
    },
    {
      icon: "🌐",
      title: "Language Learning",
      description: "Master new languages with interactive tools",
  ...
  const steps = [
    {
      ...
      desc: "Sign up and complete your profile with interests, goals, and academic background.",
    },
    {
      num: "02",
      title: "Get AI-Powered Insights",
      desc: "Our system analyzes your profile and matches you with the right opportunities.",
    },
    {
      num: "03",
      title: "Achieve Your Goals",
      desc: "Follow your personalized learning path and unlock your full potential.",
    },
  ];
  ...
  const testimonials = [
    ...
    {
      name: "Rahul Mehta",
      role: "Class 11, Mumbai",
      text: "The personalized resources and practice tests significantly improved my board exam scores. Highly recommended!",
      avatar: "RM",
      stars: 5,
    },
    {
      ...
      text: "The counselors are amazing! They guided me through choosing subjects and planning for competitive exams.",
      avatar: "AR",
      stars: 5,
    },
  ];
      ...
      >
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroSubtitle}>
            Empowering Futures through AI-powered Counselling, Assessments &
            Skill Development — aligned with Cambridge & Princeton University,
              ...
              >
                <View
                  style={[
                    ...
                    { backgroundColor: ICON_BG[idx] },
                  ]}
                >
                  <Text style={styles.featureIcon}>{feature.icon}</Text>
                </View>
                <Text style={[styles.featureTitle, { color: ICON_COLOR[idx] }]}>
                  {feature.title}
                </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.aboutText}>
            Our mission is to empower every student to discover their unique
            potential and achieve their academic and career goals.
          </Text>
          ...
          {contactSuccess ? (
            <View style={styles.contactSuccessBox}>
              ...
              <TouchableOpacity onPress={() => setContactSuccess(false)}>
                <Text style={styles.contactSuccessReset}>
            ...
            <View style={[styles.contactForm, SHADOWS.md]}>
              ...
              {contactError ? (
                <Text style={styles.contactFormError}>{contactError}</Text>
              ) : null}
              ...
              <View style={styles.subjectRow}>
                {contactSubjects.map((s) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.subjectChip,
                      contactSubject === s && styles.subjectChipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        ...
                        contactSubject === s && styles.subjectChipTextActive,
                      ]}
                    >
                      {s}
                    </Text>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.footerBrand}>
            <Text style={styles.footerLogoText}>
              The <Text style={styles.footerLogoHighlight}>3C</Text> Edge
            </Text>
            ...
            <View style={styles.socialRow}>
              {[
                {
                  icon: "📘",
                  url: "https://www.facebook.com/share/1FKwumKTsB/",
                },
                {
                  icon: "📸",
                  url: "https://www.instagram.com/shreyarthaeducation?igsh=MnhrYWRjOWxtNndn",
                },
                {
                  icon: "💼",
                  url: "https://www.linkedin.com/company/the-3c-edge/",
                },
                {
                  icon: "▶️",
                  url: "https://youtube.com/@shreyarthaeducation?si=asHvya8dQG61NBxB",
                },
          ...
          <View style={styles.footerColumns}>
            <View style={styles.footerCol}>
              ...
              {features.map((f) => (
                <TouchableOpacity
                  key={f.slug}
                  onPress={() => router.push(`/pages/${f.slug}`)}
                >
            ...
            <View style={styles.footerCol}>
              ...
              <Text style={[styles.footerColTitle, { marginTop: SPACING.lg }]}>
                Contact
              </Text>
...
const styles = StyleSheet.create({
  ...
  heroCircle1: {
    ...
    height: 260,
    borderRadius: 130,
    backgroundColor: "rgba(176,0,58,0.12)",
    top: -80,
    right: -60,
  },
  heroCircle2: {
