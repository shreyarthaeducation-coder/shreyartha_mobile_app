...
export const studentService = {
  ...
  getMyAnalyticsStudentAnalytics: () => api.get('/api/students/analytics'),
  getMyAnalyticsSyllabusCompletion: () => api.get('/api/students/syllabus-completion'),
  getMyAnalyticsProgress: () => api.get('/api/student/my-progress'),
  getMyAnalyticsCompetitiveExam: () => api.get('/api/student/competitiveexam/analytics'),
  getMyAnalyticsPsychometric: () => getFirst([
    '/api/student/psychometric/analytics',
    '/api/students/psychometric/analytics',
    '/api/psychometric/analytics',
    '/api/student/psychometric-assessment/analytics',
  ]),
  getMyAnalyticsLearningGaps: () => getFirst([
  ...
  getMyAnalyticsCodingPro: () => getFirst([
    '/api/student/coding-pro/analytics',
    '/api/students/coding-pro/analytics',
    '/api/coding-pro/analytics',
    '/api/student/codingpro/analytics',
  ]),
  getMyAnalyticsSkillsEdge: () => getFirst([
    '/api/student/skills-edge/analytics',
    '/api/students/skills-edge/analytics',
    '/api/skills-edge/analytics',
    '/api/student/skillsedge/analytics',
  ]),
