...
export const studentService = {
  ...
  getTopicContent: (topicId, category) => api.get(`/api/students/study/topics/${encodeURIComponent(topicId)}/content?category=${encodeURIComponent(category || '')}`),
  getTopicQuestions: (topicId, category) => api.get(`/api/students/study/topics/${encodeURIComponent(topicId)}/questions?category=${encodeURIComponent(category || '')}`),
